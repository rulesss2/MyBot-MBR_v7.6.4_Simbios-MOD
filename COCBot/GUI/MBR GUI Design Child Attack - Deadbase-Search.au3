...
Func CreateAttackSearchDeadBaseSearch()
	...
	$x -= 15
		...
		$g_hTxtDBMinGold = GUICtrlCreateInput("120000", $x + 85, $y, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	...
	$y += 21
		$g_hTxtDBMinElixir = GUICtrlCreateInput("120000", $x + 85, $y, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	...
	$y -= 11
		$g_hTxtDBMinGoldPlusElixir = GUICtrlCreateInput("240000", $x + 85, $y, 50, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
