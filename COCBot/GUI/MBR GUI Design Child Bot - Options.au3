...
Global $g_hChkLabCheck = 0 ; ADDED By SM MOD
Global $g_hChkSqlite = 0
Global $g_hBtnExportData = 0

;------------------ Auto Dock, Hide Emulator & Bot ADDED By SM MOD - START------------------
Global $g_hChkEnableAuto = 0, $g_hChkAutoDock = 0, $g_hChkAutoHideEmulator = 0, $g_hChkAutoMinimizeBot = 0
;------------------ Auto Dock, Hide Emulator & Bot ADDED By SM MOD - END------------------

Func CreateBotOptions()

	Local $sTxtTip = ""
	Local $x = 25, $y = 45
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Bot - Options", "Group_01", "GUI Language"), $x - 20, $y - 20, 210, 43)
		$y -= 6
	...
	$y += 50
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Bot - Options", "Group_02", "When Bot Loads"), $x - 20, $y - 20, 210, 118)
	$y -= 6
	...
	$y += 44
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Bot - Options", "Group_03", "When Bot Starts"), $x - 20, $y - 20, 210, 160)
	$y -= 6
	...
	;------------------ Auto Dock, Hide Emulator & Bot ADDED By SM MOD - START----------------
	$y += 20
		$g_hChkEnableAuto = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Bot - Options", "ChkEnableAuto", "Enable Auto for Emulator") & ":", $x , $y, -1, -1)
	...
	$y += 20
		$g_hChkAutoDock = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Bot - Options", "ChkAutoDock", "Auto Dock"), $x + 10, $y, -1, -1)
		...
		$g_hChkAutoHideEmulator = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Bot - Options", "ChkAutoHideEmulator", "Auto HIDE"), $x + 90, $y, -1, -1)
	...
	;------------------ Auto Dock, Hide Emulator & Bot ADDED By SM MOD - END------------------
	$y += 20
		$g_hChkAutoMinimizeBot = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Bot - Options", "ChkAutoMinimizeBot", "Auto Minimize Bot after Start"), $x , $y, -1, -1)
	...
	$y += 46
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Bot - Options", "Group_08", "Processor/Thread Advanced"), $x - 20, $y - 20, 210, 81)
	$y -= 6
	...
	Local $hGroup = GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Bot - Options", "Group_04", "Advanced"), $x - 20, $y - 20, 225, 162); EDITED By SM MOD
		#cs
	...
	$y += 20
		GUICtrlCreateLabel( GetTranslatedFileIni("MBR GUI Design Child Bot - Options", "LblPBTimeForcedExit", "Subtract time for early PB exit"), $x - 10, $y + 3)
			...
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_hTxtPBTimeForcedExit = GUICtrlCreateInput("18", $x + 132, $y, 30, 16, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetOnEvent(-1, "txtSinglePBTimeForced")
			GUICtrlSetLimit(-1, 3)
			GUICtrlSetState(-1, $GUI_DISABLE)
