...
Global $g_hLblNotesScriptDB = 0, $g_hBtnAttNowDB = 0 ; ADDED By SM MOD
...
Func CreateAttackSearchDeadBaseScripted()
	...
	$y += 25
		...
		$g_hBtnAttNowDB = GUICtrlCreateButton(GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttDBNow_Info_01", "Attack DB Now"), $x + 67, $y + 195, 91, 25)
			_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttDBNow_Info_02", "Attack now Button Which it will make CSV Makers/testers life Easy. You should be in Attack Screen") & @CRLF & _
							   GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttDBNow_Info_03", "NOTE: It will not attack on WAR Or Friendly Challenge Base."))
	...
	Local $x = 55, $y = 328
		GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "CSVSpeed", "CSV Deployment Speed"), $x - 2, $y, -1, -1)
			$g_hCmbCSVSpeed[$DB] = GUICtrlCreateCombo("", $x + 122, $y - 4, 50, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
