...
Func CreateSplashScreen($iSteps = Default)
	...
	If $iSteps = Default Then
		$g_iSplashTotalSteps = 11 ; EDITED By SM MOD
	Else
		$iGuiState = @SW_SHOW
	...
	Local $hImage, $iX, $iY
	Local $iT = 0 ; Top of logo (additional space) was 20 White On Top Of Colorfull image does not look good. EDITED By SM MOD
