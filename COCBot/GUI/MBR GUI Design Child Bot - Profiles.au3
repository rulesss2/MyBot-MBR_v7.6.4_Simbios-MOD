...
;------------------ REMOVED By SM Mod(These All below lines are copied into CreateSwitchAccount() function below) - START------------------
#CS 	Local $x = 25, $y = 105
...
; 	GUICtrlCreateGroup("", -99, -99, 1, 1)
 #CE
;------------------ REMOVED By SM Mod(These All below lines are copied into CreateSwitchAccount() function below) - END------------------
