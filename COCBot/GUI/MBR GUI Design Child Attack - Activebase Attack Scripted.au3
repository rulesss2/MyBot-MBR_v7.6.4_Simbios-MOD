...
Global $g_hLblNotesScriptAB = 0 , $g_hBtnAttNowAB = 0 ,$g_hbtnAttNow = 0 ; ADDED By SM MOD
...
Func CreateAttackSearchActiveBaseScripted()
	...
	$y += 25
		...
		$g_hBtnAttNowAB = GUICtrlCreateButton(GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttABNow_Info_01", "Attack AB Now"), $x , $y + 195, 91, 25)
			_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttABNow_Info_02", "Attack now Button Which it will make CSV Makers/testers life Easy. You should be in Attack Screen") & @CRLF & _
							   GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttABNow_Info_03", "NOTE: It will not attack on WAR Or Friendly Challenge Base."))
			GUICtrlSetOnEvent(-1, "AttackNowAB"); ADDED By SM MOD

		$g_hBtnAttNowAB = GUICtrlCreateButton(GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttNow_Info_01", "Attack Now"), $x + 140, $y + 195, 91, 25)
			_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttNow_Info_02", "Attack now Button Which it will make CSV Makers/testers life Easy. You should be in Attack Screen") & @CRLF & _
							   GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttNow_Info_03", "NOTE: It will attack on any base But it will not zoomout the village."))
	...
	Local $x = 55, $y = 328
		GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "CSVSpeed", -1), $x - 2, $y, -1, -1)
			$g_hCmbCSVSpeed[$LB] = GUICtrlCreateCombo("", $x + 122, $y - 4, 50, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
