...
Global $g_hLblNotesScriptAB = 0 , $g_hBtnAttNowAB = 0 ; EDITED By SM MOD was $g_hbtnAttNow
...
Func CreateAttackSearchActiveBaseScripted()
	...
	$y += 25
		...
		$g_hBtnAttNowAB = GUICtrlCreateButton(GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttNow_Info_02", "Attack Now"), $x + 67, $y + 195, 91, 25)
			_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "btnAttNow_Info_01", -1))
			GUICtrlSetOnEvent(-1, "AttackNowAB") ; EDITED By SM MOD  was AttackNow
