...
Global $g_hChkReturnTimerEnable = 0, $g_hTxtReturnTimer = 0 ; Return Home by Time ; ADDED By SM MOD
Global $g_hChkAttackPriority = 0 ; Attack Priority ; ADDED By SM MOD
Global $g_hChkEnableDropEmptySiege = 0, $g_hChkLBDropEmptySiege= 0, $g_hChkDBDropEmptySiege = 0 ; Drop Empty Siege Machines ; ADDED By SM MOD
...
Func CreateAttackSearchOptionsSearch()
	...
	$x = 253
	$y = 45
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Search", "Group_03", "Search Options"), $x - 20, $y - 20, 189, 260); Was , 165) EDITED By SM MOD
	$x -= 10
	...
	$y += 25
		...
		;Attack Priority
	$y += 25
		$g_hChkAttackPriority = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Search", "ChkAttackPriority", "Attack Priority"), $x - 5, $y - 1, -1, -1)
		    _GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Search", "ChkAttackPriority_Info_01", "When a double army is ready attack again and again skip extra checks."))
		    GUICtrlSetState(-1, $GUI_CHECKED)
		;Drop Empty Siege Machines
	$y += 25
		$g_hChkEnableDropEmptySiege = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Search", "ChkDropEmptySiege", "Drop Empty Siege Machines:"), $x - 5, $y - 1, -1, -1)
			_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Search", "ChkDropEmptySiege_Info_01", "Check it to Enable To Drop empty siege machines in active & dead base."))
			GUICtrlSetState(-1, $GUI_UNCHECKED)
			GUICtrlSetOnEvent(-1, "chkEnableDropEmptySiege")
	...
	$y += 20
		$g_hChkLBDropEmptySiege = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Search", "ChkLBDropEmptySiege", "LB Siege Drop"), $x - 5, $y, -1, -1)
			$sTxtTip = GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Search", "ChkLBDropEmptySiege_Info_01", "Drop empty siege machines in active base.")
			_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_DISABLE)
		...
		$g_hChkDBDropEmptySiege = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Search", "ChkDBDropEmptySiege", "DB Siege Drop"), $x + 85, $y, -1, -1)
			$sTxtTip = GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Search", "ChkDBDropEmptySiege_Info_01", "Drop empty siege machines in dead base.")
			_GUICtrlSetTip(-1, $sTxtTip)
			GUICtrlSetState(-1, $GUI_DISABLE)
			GUICtrlSetOnEvent(-1, "chkDropEmptySiege")
	    ;------------------ADDED By SM MOD - END------------------
