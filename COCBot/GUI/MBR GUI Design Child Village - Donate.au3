...
; Request CC Troops CC First - Added by SM MOD
Global $g_hChkReqCCFirst = 0
Global $g_hLblEarly

; Russian Request - Added by SM MOD
Global $g_hChkRusLang2 = 0

; Request troops for defense - Added by SM MOD
Global $g_hChkRequestCCDefense, $g_hTxtRequestCCDefense, $g_hCmbRequestCCDefenseWhen, $g_hTxtRequestCCDefenseTime

; Don't retype when request troops ( just once ) - Added by SM MOD
...
Func CreateRequestSubTab()
	...
	$x += 10
		...
		$g_hChkRequestTypeOnceEnable = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Village - Donate-CC", "ChkRequestTypeOnceEnable", "Type Once"), $x + 215, $y - 6); Don't retype when request troops ( just once ) - Added by SM MOD
	...
	$y += 25
		...
		$g_hTxtRequestCountCCTroop = GUICtrlCreateInput("0", $x + 140, $y - 23, 25, 16, BitOR($SS_RIGHT, $ES_NUMBER))
			GUICtrlSetLimit(-1, 2)
			...
			Else
				GUICtrlSetState(-1, $GUI_DISABLE)
			EndIf
		$g_hTxtRequestCountCCSpell = GUICtrlCreateInput("0", $x + 195, $y - 23, 25, 16, BitOR($SS_RIGHT, $ES_NUMBER))
			GUICtrlSetLimit(-1, 1)
