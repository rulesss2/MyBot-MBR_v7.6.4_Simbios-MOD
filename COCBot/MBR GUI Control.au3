...
Func GUIControl_WM_NOTIFY($hWind, $iMsg, $wParam, $lParam)
	...
	Switch $nID
		Case $g_hTabMain
			...
			If GUICtrlRead($g_hTabMain, 1) = $g_hGUI_MOD And GUICtrlRead($g_hGUI_MOD_TAB, 1) = $g_hGUI_MOD_TAB_FORECAST Then
...
Func SetRedrawBotWindow($bEnableRedraw, $bCheckRedrawBotWindow = Default, $bForceRedraw = Default, $RedrawControlIDs = Default, $sSource = "")
	...
	EndIf
	redrawForecast() ; ADDED By SM MOD
	Return $bWasRedraw
...
;------------------ADDED By SM MOD - START------------------
Func tabMOD()
	Local $tabidx = GUICtrlRead($g_hGUI_MOD_TAB, 1)
	Select
		Case $tabidx = $g_hGUI_MOD_TAB_HUMANIZATION
			SetDebugLog("Humanization Tab Selected")
		Case $tabidx = $g_hGUI_MOD_TAB_GTFO
			SetDebugLog("GTFO Tab Selected")
		Case $tabidx = $g_hGUI_MOD_TAB_WAR_PREPARATION
			SetDebugLog("War Preparation Tab Selected")
		Case $tabidx = $g_hGUI_MOD_TAB_CHATBOT
			SetDebugLog("ChatBot Tab Selected")
		Case $tabidx = $g_hGUI_MOD_TAB_GOBLIN_XP
			SetDebugLog("Goblin XP Tab Selected")
		Case $tabidx = $g_hGUI_MOD_TAB_FORECAST
			SetDebugLog("Forecast Tab Selected")
		Case $tabidx = $g_hGUI_MOD_TAB_SWITCH_PROFILES
			SetDebugLog("Switch Profiles Tab Selected")
		Case $tabidx = $g_hGUI_MOD_TAB_SM_DEBUG
			SetDebugLog("SM Debug Tab Selected")
	EndSelect
EndFunc   ;==>tabMOD
;------------------ADDED By SM MOD - END------------------
;---------------------------------------------------
