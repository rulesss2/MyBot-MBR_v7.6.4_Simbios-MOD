...
Global $g_hTabMain = 0, $g_hTabLog = 0, $g_hTabVillage = 0, $g_hTabAttack = 0, $g_hTabBot = 0, $g_hTabAbout = 0, $g_hTabMOD = 0 ; ADDED By SM MOD
...
#include "Simbios MOD\SM MOD GUI Design.au3" ; ADDED By SM Mod
...
;~ ------------------------------------------------------
	...
	$g_hTabMOD = GUICtrlCreateTabItem(GetTranslatedFileIni("MBR Main GUI", "Tab_06", "MOD")) ; ADDED By SM MOD
...
;~ -------------------------------------------------------------
	...
	Static $g_hGUI_MOD_TAB_ImageList = 0 ; ADDED By SM MOD
	Static $g_hGUI_BOT_TAB_ImageList = 0
	Static $g_hGUI_SWITCH_OPTIONS_TAB_ImageList = 0 ; ADDED By SM MOD
	...
	Bind_ImageList($g_hGUI_MOD_TAB, $g_hGUI_MOD_TAB_ImageList) ; ADDED By SM MOD
	Bind_ImageList($g_hGUI_BOT_TAB, $g_hGUI_BOT_TAB_ImageList)
	Bind_ImageList($g_hGUI_SWITCH_OPTIONS_TAB, $g_hGUI_SWITCH_OPTIONS_TAB_ImageList) ; ADDED By SM MOD
