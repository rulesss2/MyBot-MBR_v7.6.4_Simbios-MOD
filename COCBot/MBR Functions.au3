...
#include "functions\Village\GetLabLevel.au3" ;Added By Simbion Mod
#include "functions\Village\HaltTrigger.au3" ;Added By Simbion Mod
...
#include "Simbios MOD\SM MOD Functions.au3"; ADDED By SM MOD
