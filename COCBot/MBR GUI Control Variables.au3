...
Global $aTabControlsStrategies, $aTabControlsBot, $aTabControlsSwitchOpt, $aTabControlsMOD, $aTabControlsStats ; EDITED By SM MOD
...
Func InitializeControlVariables()
	...
	Dim $aTabControlsMOD = [$g_hGUI_MOD_TAB, $g_hGUI_MOD_TAB_HUMANIZATION,$g_hGUI_MOD_TAB_GTFO, $g_hGUI_MOD_TAB_WAR_PREPARATION, $g_hGUI_MOD_TAB_CHATBOT, $g_hGUI_MOD_TAB_GOBLIN_XP, $g_hGUI_MOD_TAB_FORECAST, $g_hGUI_MOD_TAB_SWITCH_PROFILES,$g_hGUI_MOD_TAB_SM_DEBUG]; ADDED By SM MOD
	...
	$oAlwaysEnabledControls($g_hTabMOD) = 1 ; ADDED By SM MOD
