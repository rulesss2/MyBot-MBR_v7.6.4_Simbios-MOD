...
Func AttackSmartFarm($Nside, $SIDESNAMES)
	...
	If $g_bUseEventTroops Then
		...
		Next
		$listInfoDeploy[0][0] = $eEventTroop2GiaSkel
		$listInfoDeploy[0][1] = $nbSides
		$listInfoDeploy[0][2] = 1
		$listInfoDeploy[0][3] = 1
		$listInfoDeploy[0][4] = 0
		$listInfoDeploy[$iListInfoDeployCount - 1][0] = $eEventTroop1SkelBar
				...
				For $i = 0 To $numberSidesDropTroop - 1
					For $j = 0 To UBound($listInfoDeployTroopPixel) - 1
						...
						Else
							...
							DropOnPixel($infoTroopListArrPixel[0], $pixelDropTroop, $infoTroopListArrPixel[2], $infoTroopListArrPixel[3], True) ; EDITED By SM MOD
						EndIf
