...
Func SaveRegularConfig()
	...
	SaveConfig_SMMod() ; ADDED By SM MOD
...
Func SaveConfig_600_6()
	...
	_Ini_Add("other", "chkCleanYardBB", $g_bChkCleanYardBB ? 1 : 0);Builder Base Clean Yard - ADDED by SM MOD
...
Func SaveConfig_600_11()
	...
	_Ini_Add("request", "RequestTypeOnce", $g_bRequestTypeOnceEnable ? 1 : 0) ; Don't retype text when request troops ( just once ) - Added by SM MOD
...
Func SaveConfig_600_52_2()
	...
	_Ini_Add("troop", "ChkSmartQueueSystem", $g_bSmartQueueSystem ? True : False)

	; ================================================ Use Event Troops & Spells - SM MOD ========================================
	_Ini_Add("troop", "ChkUseEventTroops" ,$g_bUseEventTroops ? True : False)
