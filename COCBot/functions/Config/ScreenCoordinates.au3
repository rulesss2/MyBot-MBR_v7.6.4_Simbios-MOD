...
Global $aReloadButton51[4] = [205, 390 + $g_iMidOffsetY, 0x434545, 10] ; Reload Coc Button after PBT Android 5.1 [$g_iAndroidVersionAPI = $g_iAndroidLollipop] ; ADDED By SM MOD
Global $aReloadButton71[4] = [205, 390 + $g_iMidOffsetY, 0x434545, 10] ; Reload Coc Button after PBT Android 7.1 [$g_iAndroidVersionAPI = $g_iAndroidNougat] ; ADDED By SM MOD
