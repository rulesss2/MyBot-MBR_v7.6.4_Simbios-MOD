...
Func setupProfileComboBox()
	...
	$profileString = "" ; was Local $profileString = "" EDITED By SM MOD
	...
	GUICtrlSetData($g_hCmbForecastHopingSwitchMin, "", ""); ADDED By SM MOD
	GUICtrlSetData($g_hCmbForecastHopingSwitchMax, "", ""); ADDED By SM MOD
	; Set the new data of available profiles
	GUICtrlSetData($g_hCmbProfile, $profileString, "<No Profiles>")
    GUICtrlSetData($g_hCmbForecastHopingSwitchMax, $profileString, "<No Profiles>"); ADDED By SM MOD
	GUICtrlSetData($g_hCmbForecastHopingSwitchMin, $profileString, "<No Profiles>"); ADDED By SM MOD
	For $i = 0 To 7
