...
Func ReadRegularConfig()
	...
	ReadConfig_SMMod() ; ADDED By SM MOD
...
Func ReadConfig_600_6()
	...
	IniReadS($g_bChkCleanYardBB, $g_sProfileConfigPath, "other", "chkCleanYardBB", False, "Bool") ;Builder Base Clean Yard - ADDED by SM MOD
...
Func ReadConfig_600_11()
	...
	$g_bRequestTypeOnceEnable = (IniRead($g_sProfileConfigPath, "request", "RequestTypeOnce", "0") = "1") ; Don't retype text when request troops ( just once ) - Added by SM MOD
	...
	For $i = 0 To 2
		...
		If $g_aiClanCastleTroopWaitType[$i] >= 0 And $g_aiClanCastleTroopWaitType[$i] < $eTroopCount Then ; barb - bowl EDITED By SM MOD Crash fix when value was -1
			$g_aiCCTroopsExpected[$g_aiClanCastleTroopWaitType[$i]] += $g_aiClanCastleTroopWaitQty[$i]
		Else
			$g_aiClanCastleTroopWaitType[$i] = 20
		EndIf
	Next
	For $i = 0 To 1
		...
		If $g_aiClanCastleSpellWaitType[$i] >= 0 And $g_aiClanCastleSpellWaitType[$i] < $eSpellCount Then ; LSpell - SkSpell EDITED By SM MOD Crash fix when value was -1
			$g_aiCCSpellsExpected[$g_aiClanCastleSpellWaitType[$i]] += $g_aiClanCastleSpellWaitQty[$i]
		Else
			$g_aiClanCastleSpellWaitType[$i] = 10
		EndIf
	Next
...
Func ReadConfig_600_52_2()
	...
	IniReadS($g_iTxtFillArcher, $g_sProfileConfigPath, "SmartTrain", "TxtFillArcher", $g_iTxtFillArcher, "int")
	IniReadS($g_bChkFillEQ, $g_sProfileConfigPath, "SmartTrain", "ChkFillEQ", False, "Bool")

	; ================================================ Smart Queue System - by SM MOD ========================================
	IniReadS($g_bSmartQueueSystem, $g_sProfileConfigPath, "troop", "ChkSmartQueueSystem", False, "Bool")

	; ================================================ Use Event Troops & Spells - SM MOD ========================================
	IniReadS($g_bUseEventTroops, $g_sProfileConfigPath, "troop", "ChkUseEventTroops", False, "Bool")
