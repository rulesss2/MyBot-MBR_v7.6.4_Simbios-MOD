...
Func applyConfig($bRedrawAtExit = True, $TypeReadSave = "Read") ;Applies the data from config to the controls in GUI
	...
	ApplyConfig_SMMod($TypeReadSave) ; ADDED By SM MOD
...
Func ApplyConfig_600_6($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkCleanYardBB, $g_bChkCleanYardBB ? $GUI_CHECKED : $GUI_UNCHECKED) ;Builder Base Clean Yard - ADDED by SM MOD
		...
		Case "Save"
			...
			$g_bChkCleanYardBB = (GUICtrlRead($g_hChkCleanYardBB) = $GUI_CHECKED);Builder Base Clean Yard - ADDED by SM MOD
...
Func ApplyConfig_600_11($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkRequestTypeOnceEnable, $g_bRequestTypeOnceEnable ? $GUI_CHECKED : $GUI_UNCHECKED) ; Don't retype text when request troops ( just once ) - Added by SM MOD
			; Request Type - Demen
		...
		Case "Save"
			...
			$g_bRequestTypeOnceEnable = (GUICtrlRead($g_hChkRequestTypeOnceEnable) = $GUI_CHECKED) ; Don't retype text when request troops ( just once ) - Added by SM MOD
...
Func ApplyConfig_600_17($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			; ================================================== Wall/Building Upgrading Priority by SM MOD	========================;
...
Func ApplyConfig_600_22($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			_GUICtrlComboBox_SetCurSel($g_hCmbBoostWorkshop, $g_iCmbBoostWorkshop) ; ADDED BY SM MOD
...
Func ApplyConfig_600_29_DB_Standard($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			; ================================================= Classic Foure Fingers - Added by SM MOD ========================= ;
...
Func ApplyConfig_600_52_2($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			; ================================================ Smart Queue System - by SM MOD ========================================
			GUICtrlSetState($g_hChkSmartQueueSystem, $g_bSmartQueueSystem ? $GUI_CHECKED : $GUI_UNCHECKED)
			chkSmartQueueSystem()

			; ================================================ Use Event Troops & Spells - SM MOD ========================================
			GUICtrlSetState($g_hChkUseEventTroops, $g_bUseEventTroops ? $GUI_CHECKED : $GUI_UNCHECKED)
			chkUseEventTroops()
		...
		Case "Save"
			...
			; ================================================ Smart Queue System - by SM MOD ========================================
			$g_bSmartQueueSystem = (GUICtrlRead($g_hChkSmartQueueSystem) = $GUI_CHECKED)
