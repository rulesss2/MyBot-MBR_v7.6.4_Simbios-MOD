...
Func CheckVersionHTML()
	...
	Else
		;download page from site contains last bot version
        Local $hDownload = InetGet("https://raw.githubusercontent.com/rulesss2/MyBot-MBR_v7.6.2_Simbios-MOD/master/LastVersion.txt", $versionfile, 0, 1)
	...
	If FileExists($versionfile) Then
		...
		Else
            ...
            $hDownload = InetGet("https://raw.githubusercontent.com/rulesss2/MyBot-MBR_v7.6.2_Simbios-MOD/master/LastVersion_" & $g_sLanguage & ".txt", $versionfilelocalized, 0, 1)
			; Wait for the download to complete by monitoring when the 2nd index value of InetGetInfo returns True.
			Local $i = 0
			Do
				Sleep($DELAYCHECKVERSIONHTML1)
