...
Func CheckCCArmy()
	...
	If $g_abRequestType[1] And $g_iClanCastleSpellsWaitFirst > 0 And $g_iCurrentCCSpells > 0 And $g_iTotalCCSpells > 0 Then
		;If $g_abRequestType[1] And $g_iClanCastleSpellsWaitFirst > 0 And $g_iCurrentCCSpells = $g_iTotalCCSpells And $g_iTotalCCSpells > 0 Then ;Removed By SM MOD Offical Bug Fix
...
Func CompareCCSpellWithGUI($CCSpell1, $CCSpell2, $CastleCapacity)
	...
	If $g_bDebugSetlog Then ; Just For debug
		If IsArray($CCSpell1) And UBound($CCSpell1, 2) > 0 Then ; If Array Is 2D Array ; Added By SM MOD Offical Bug Fix
			...
			EndIf
		Else
			If $g_bDebugSetlog Then SetLog("ERROR: $CCSpell1 is NOT Array", $COLOR_ERROR)
		EndIf
	EndIf
			...
			Case 1 ; One Spell on Slot 1
				...
				If $sCCSpell <> "Any" Then
					If $sCCSpell <> $CCSpell1[0][0] Then ; First Spell not in Slot 1
						...
						If $CastleCapacity = 2 And $g_iClanCastleSpellsWaitFirst > 4 And Not ($CCSpell1[0][0] = "LSpell" Or $CCSpell1[0][0] = "HSpell" Or $CCSpell1[0][0] = "RSpell" Or $CCSpell1[0][0] = "JSpell") Then ;Was If $CastleCapacity = 2 And $g_iClanCastleSpellsWaitFirst > 4 Then  EDITED BY SM MOD
