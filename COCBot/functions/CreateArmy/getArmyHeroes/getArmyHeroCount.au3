...
Func LabGuiDisplay() ; called from main loop to get an early status for indictors in bot bottom
	...
	If _ColorCheck(_GetPixelColor(730, 200, True), Hex(0xA2CB6C, 6), 20) Or _ ; Look for light green in upper right corner of lab window.
			_ColorCheck(_GetPixelColor(730, 200, True), Hex(0x718F30, 6), 20) Then ; ADDED By SM MOD Fix for Nox emulator
