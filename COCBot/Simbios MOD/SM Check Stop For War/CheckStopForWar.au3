...
Func StopAndPrepareForWar($iSleepTime)
	...
	If $g_bRequestCCForWar Then
		...
		;$g_iClanCastleSpellsWaitFirst = 10 ; fake to cheat CompareCCSpellWithGUI() ; Edited By SM MOD
		;$g_iClanCastleSpellsWaitSecond = 6 ; fake to cheat CompareCCSpellWithGUI() ; Edited By SM MOD
