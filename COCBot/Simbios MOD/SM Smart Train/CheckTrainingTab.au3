...
Func CheckTrainingTab($sText = "Troops")
	...
	If $sText = "Troops" Then
		If Not OpenTroopsTab(True, "CheckTrainingTab") Then $g_sSmartTrainError = SetError(2, 0, "Error OpenTroopsTab called from CheckTrainingTab")
	Else
		If Not OpenSpellsTab(True, "CheckTrainingTab") Then $g_sSmartTrainError = SetError(2, 0, "Error OpenSpellsTab called from CheckTrainingTab")
	EndIf
...
Func ClearTrainingArmyCamp($OpenTabNumber = "Current", $bReturnArmyTab = False)
	...
	If $OpenTabNumber = "Troop" Then
		If Not OpenTroopsTab(True, "ClearTrainingArmyCamp") Then $g_sSmartTrainError = SetError(3, 0, "Error OpenTroopsTab called from ClearTrainingArmyCamp")
	ElseIf $OpenTabNumber = "Spell" Then
		If Not OpenSpellsTab(True, "ClearTrainingArmyCamp") Then $g_sSmartTrainError = SetError(3, 0, "Error OpenSpellsTab called from ClearTrainingArmyCamp")
	EndIf
	If @error Then Return ; quit SmartTrain
