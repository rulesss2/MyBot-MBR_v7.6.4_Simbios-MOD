...
Func BB_Attack($Nside = 1, $SIDESNAMES = "TR|TL", $iTroopToDeploy = 1)
	...
	If $iTroopToDeploy < 1 Then $iTroopToDeploy = 1 ; Witch Is Min ; EDITED By SM MOD
	If $iTroopToDeploy > 10 Then $iTroopToDeploy = 10 ;Drop troops in wave max 10 in one round
	...
	For $i = $iHalf To 1 Step -1
		...
		If _Sleep($DELAYDROPTROOP1) Then Return
		If Not Mod($iTroopToDeploy, 2) Or $i <> 1 Then ; If $iTroopToDeploy is Odd No like 1,3,5,7,11 Then Don't run this click in the end - EDITED By SM MOD
