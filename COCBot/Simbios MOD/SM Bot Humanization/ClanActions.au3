	...
	If ChatOpen() Then
		...
		If IsClanChat() Then
			...
			If IsClanOverview() Then
				If QuickMIS("BC1", @ScriptDir & "\imgxml\Resources\Bot Humanization\WarLog", 20, 390, 70, 430) Then ; October Update Changed
					Click($g_iQuickMISX+20, $g_iQuickMISY+390) ; open war log
					randomSleep(1500)
