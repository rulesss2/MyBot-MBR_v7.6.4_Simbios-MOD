...
Func LookAtCurrentWar()
	...
	If IsWarMenu() Then
		Local $bWarType = QuickMIS("N1", @ScriptDir & "\imgxml\Resources\Bot Humanization\CurrentWar", 740, 320, 835, 580) ;October Update
		If $bWarType = "CurrentWar" Or $bWarType = "CurrentWarCwl" Then ;Check if it is Simple War Or Cwl War
			...
			If $bWarType = "CurrentWar" Then Click(800, 670) ; go to war details
			If $bWarType = "CurrentWarCwl" Then Click(810, 570) ; go to Cwl war details
			randomSleep(1500)
...
Func WatchWarReplays()
	...
	randomSleep(5000)
	Local $bWarType = QuickMIS("N1", @ScriptDir & "\imgxml\Resources\Bot Humanization\CurrentWar", 740, 320, 835, 580) ;October Update
	If (QuickMIS("BC1", @ScriptDir & "\imgxml\Resources\Bot Humanization\WarDetails", 740, 620, 850, 720) And $bWarType = "CurrentWar") Or $bWarType = "CurrentWarCwl" Then
		SetLog("Open War details menu...", $COLOR_ACTION1)
		If $bWarType = "CurrentWar" Then Click(800, 670) ; go to war details
		If $bWarType = "CurrentWarCwl" Then Click(810, 570) ; go to Cwl war details
		randomSleep(1500)
