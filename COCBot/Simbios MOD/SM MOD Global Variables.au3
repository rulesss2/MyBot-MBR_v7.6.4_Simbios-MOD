...
;SuperXP / GoblinXP
Global $g_bEnableSuperXP = False, $g_irbSXTraining = 1, $g_bSXBK = False, $g_bSXAQ = False, $g_bSXGW = False, $g_iStartXP = 0, $g_iCurrentXP = 0, $g_iGainedXP = 0, $g_iGainedXPHour = 0, $g_iTxtMaxXPtoGain = 500
...
Global Const $g_aButtonLangSettingBackLang[6] = [127, 121, 127, 121, 0xB4E35C, 20] ; On Setting screen language screen back button
...
Global $g_iLabCost[32][11] = [ _
	...
	[0, 100000, 250000, 750000, 200000, 6000000, 9000000, 12000000, "Max", "Max", "Max"], _ 			;Wall Breaker
