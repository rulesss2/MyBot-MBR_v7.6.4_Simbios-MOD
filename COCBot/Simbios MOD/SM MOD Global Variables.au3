...
; ======================== Check Collector Outside - Added by SM MOD ======================================== ;
...
;=============================================== Max logout time - Added by SM MOD ======================================== ;
...
; ================================================== Boost for Magic Spell - Added by SM MOD ================================= ;
...
; ================================================== Wall/Building Upgrading Priority/Management - Added by SM MOD ======================================== ;
...
; ================================================== ; Return Home by Time - Added by SM MOD ======================================== ;
...
; ================================================== SmartTrain - Added by SM MOD (Demen) ======================================== ;
...
; ================================================== ; Attack Priority - Added by SM MOD ======================================== ;

Global $g_bChkAttackPriority = False

; ================================================== ; Hero Boost Time - Added by SM MOD ======================================== ;

Global $HeroTimeRem[8][3] = [["", "", ""], ["", "", ""], ["", "", ""], ["", "", ""], ["", "", ""], ["", "", ""], ["", "", ""], ["", "", ""]]
Global $HeroTime[8][3] = [["", "", ""], ["", "", ""], ["", "", ""], ["", "", ""], ["", "", ""], ["", "", ""], ["", "", ""], ["", "", ""]]

; ================================================== ; Priority System - Added by SM MOD ======================================== ;
...
; ================================================== Halt Attack Addons - Added by SM MOD =========================================== ;

Global $g_iHaltTrigger = 0

; ================================================== Don't retype text when request troops ( just once ) - Added by SM MOD =========================================== ;

Global $g_iRequestTroopTypeOnce = 0
Global $g_bRequestTypeOnceEnable = False

; ================================================== Builder Base Clean Yard - Added by SM MOD =========================================== ;

Global $g_bChkCleanYardBB = False
Global $g_aaiBBPolygonPoints[6][2] = [[4, -1], [470, 125], [70, 425], [465, 710], [855, 410], [470, 125]] ; [[Number of sides of Polygon, -1], [TopX, TopY], [LeftX, LeftY], [BottomX, BottomY], [RightX, RightY], [1stpointX, 1stpointY]]
Global $g_BBCocDiamondECD = "460,115|850,420|460,720|70,420" ; Builder Base Diamond "StartX,StartY|EndX,StartY|EndX,EndY|StartX,EndY"

; ================================================== Use Event Troops & Spells - SM MOD - Added by SM MOD =========================================== ;

Global $g_bUseEventTroops = False